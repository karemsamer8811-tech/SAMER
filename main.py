    ...
    <div class="footer-section">
        <div class="meta-footer">
            <div class="meta-brand">
                Meta
                <svg viewBox="0 0 24 24">
                    <path d="M18.2 12.1C18.8 11.5 19.2 10.7 19.2 9.8C19.2 7.9 17.6 6.3 15.7 6.3C14.3 6.3 13.1 7.1 12.5 8.3C11.9 7.1 10.7 6.3 9.3 6.3C7.4 6.3 5.8 7.9 5.8 9.8C5.8 10.7 6.2 11.5 6.8 12.1L12.5 18L18.2 12.1Z"/>
                </svg>
            </div>
        </div>
